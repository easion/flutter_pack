...
class FlutterpiCache extends FlutterCache {
  ...
  ArtifactUpdater _createUpdater() {
	  print("getDownloadDir --> ${getDownloadDir()}  -- ${flutterpiCiBaseUrl} ");
    ...
    for (final ArtifactSet artifact in _artifacts) {
      final required = switch (artifact) {
        FlutterpiEngineCIArtifact _ => switch (artifact) {
			...
			FlutterpiEngineBinariesRK3399 _ => flutterpiPlatforms.contains(FlutterpiTargetPlatform.rk3399),
...
class FlutterpiArtifactPaths {
  String getTargetDirName(FlutterpiTargetPlatform target) {
    return switch (target) {
      ...
      FlutterpiTargetPlatform.rk3399 => 'flutterpi-rk3399',
    };
  }
...
class FlutterpiEngineBinariesRK3399 extends FlutterpiEngineCIArtifact {
  FlutterpiEngineBinariesRK3399(
    ...
    required Platform platform,
        ...
        super(
          'flutterpi-engine-binaries-rk3399',
          cache,
          DevelopmentArtifact.universal,
        );
  ...
  List<(String, String)> getBinaryDirTuples() {
    ...
    return [
      ('flutterpi-rk3399/linux-x64', 'rk3399.tar.xz'),
    ];
  }
}
...
class FlutterpiCachedGenSnapshotArtifacts implements Artifacts {
  ...
  String _getGenSnapshotPath(BuildMode buildMode) {
    ...
    final subdir = switch ((_flutterpiTargetPlatform, hostPlatform)) {
      ...
      (rk3399, linux_x64) => const ['flutterpi-rk3399', 'linux-x64'],
...
class BuildCommand extends Command<int> {
  ...
  static const cpus = ['generic', 'pi3', 'pi4', 'rk3399'];
